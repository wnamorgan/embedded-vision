# Project Pivots & Workplan

This document captures what must be built, why, and what “done” means.
...
## Pivot 1 — GPS-Based Cueing & Gremsy Captive-Flight Calibration
...
## Pivot 2 — Aravis Camera Container + ZeroMQ + Shared Memory

### Goal
Expose camera frames as a first-class stream with zero copies.

### Design Constraints
- ZeroMQ for control/metadata only
- Shared memory for image buffers

### Work Items
- Containerize Aravis
- Shared memory frame buffers
- ZMQ publishes shm handle, shape, format, timestamp

### Definition of Done
- One producer, multiple consumers
- No frame copies
- Verified latency and frame rate

---

## Pivot 3 — Web UI for Test & Configuration
...
## Pivot 4 — Subsystem Architecture
...
## Pivot 6 — Sensor Calibration & Geometry
...
## Pivot 7 — SOT timing integration with gyro propagation
...
## Pivot 8 — CFT Platform Telemetry Integration
